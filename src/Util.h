...
class Util {
	public:
		...
		static constexpr double ULTRASONIC_TURN_MULTIPLIER = 0.0975; //The amount we reduce motor speed for ultrasonic staightDrive 0.0775//0.0975(current reliable test value)
