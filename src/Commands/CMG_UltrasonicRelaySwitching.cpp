...
CMG_UltrasonicRelaySwitching::CMG_UltrasonicRelaySwitching() {
	...
	AddSequential(new UltrasonicStoreLastValue(UltrasonicSubsystem::SensorSide::frontSensor));
	...
	AddSequential(new UltrasonicStoreLastValue(UltrasonicSubsystem::SensorSide::rearSensor));
